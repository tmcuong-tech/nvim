...
let g:floaterm_rootmarkers = [
      \ '.git', 'CMakeLists.txt', 'Makefile', 'pyproject.toml',
      \ 'package.json', 'Cargo.toml', 'pom.xml', 'build.gradle', '.pro'
      \ ]
if has('win32')
  if executable('pwsh')
...
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" Git
nnoremap <silent> <leader>gl :FloatermNew! --position=bottomright --height=0.95 --width=0.7 --title='GitLog' git log --graph --all --decorate --oneline<CR>
